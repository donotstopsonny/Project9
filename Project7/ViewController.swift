...
//  Project7
//
//  Created by Hyeongchae Son on 7/21/24.
//
...
class ViewController: UITableViewController {
    ...
    @objc func askFilter() {
        let ac = UIAlertController(title: "Filter", message: "Filter the petitions by type:", preferredStyle: .alert)
        ac.addTextField()
    ...
    func filterData() {
        ...
        navigationItem.leftBarButtonItem?.title = "Filter: \(filterKeyword)"
